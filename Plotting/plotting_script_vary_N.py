...
line = 4
marker = 13
plt.plot(hardness, ae, '--X', color = 'darkolivegreen', linewidth = line, markersize = marker)
plt.plot(hardness, feas_BAI, '-X', color = 'darkolivegreen', linewidth = line, markersize = marker)
plt.plot(hardness, CSS_LUCB, ':X', color = 'darkolivegreen', linewidth = line, markersize = marker)
# plt.title("Experiment 1")
plt.xticks(fontsize = size)
plt.yticks(fontsize = size)
plt.legend(["N = 4", "N = 5", "N = 6"], fontsize = size, loc = 'upper left')
